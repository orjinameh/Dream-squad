...
const PlayerStatsSchema = new Schema<PlayerStatsDoc>(
  {
    ...
    favoriteChar: { type: String, default: "dreamer", maxlength: 32 },
    lastPlayedAt: { type: Date, default: () => new Date() },
    lastBotResultKey: { type: String, maxlength: 128 },
    // PvP
    pvpWins: { type: Number, default: 0, min: 0 },
    pvpLosses: { type: Number, default: 0, min: 0 },
    pvpDraws: { type: Number, default: 0, min: 0 },
    pvpMatches: { type: Number, default: 0, min: 0 },
    pvpRounds: { type: Number, default: 0, min: 0 },
    pvpCorrectPredictions: { type: Number, default: 0, min: 0 },
    // Bot
    botWins: { type: Number, default: 0, min: 0 },
    botLosses: { type: Number, default: 0, min: 0 },
    botDraws: { type: Number, default: 0, min: 0 },
    botMatches: { type: Number, default: 0, min: 0 },
    botRounds: { type: Number, default: 0, min: 0 },
    botCorrectPredictions: { type: Number, default: 0, min: 0 },
    // Streaks
    bestWinStreak: { type: Number, default: 0, min: 0 },
    bestPredictionStreak: { type: Number, default: 0, min: 0 },
    currentWinStreak: { type: Number, default: 0, min: 0 },
    currentPredictionStreak: { type: Number, default: 0, min: 0 },
    // Combat
    knockouts: { type: Number, default: 0, min: 0 },
    timesKnockedOut: { type: Number, default: 0, min: 0 },
    // Rank
