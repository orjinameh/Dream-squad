export interface CharacterDef {
  ...
  spell: { name: string; color: string };
  desc: string;
}
...
export const CHARACTERS: CharacterDef[] = [
  {
    ...
    spell: { name: "VOID BLAST", color: "#a855f7" },
  ...
  },
  {
    ...
    spell: { name: "CHAOS FLAME", color: "#f97316" },
  ...
  },
  {
    ...
    spell: { name: "DATA PULSE", color: "#22d3ee" },
  ...
  },
  {
    ...
    spell: { name: "MOON BLAST", color: "#eab308" },
  ...
  },
  {
    ...
    spell: { name: "DREAM FLARE", color: "#10b981" },
  ...
  },
  {
    ...
    spell: { name: "SHADOW STRIKE", color: "#6366f1" },
